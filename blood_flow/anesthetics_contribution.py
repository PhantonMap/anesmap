...
if __name__ == '__main__':
    label_def = pd.read_excel('data/brain_regions.xlsx')
    ...
    data_path = r'data/brain1.npy'
    save_dir = './results/five_anesthetics_contribution'
            ...
            'tasks': [
                {
                    ...
                    'task': 'Dex-Anesthetic/Conscious',
                    'target_labels': [['dex_conscious_female'],
                                      ['dex_anesthesia_female']]
                },
                {
                    'classification_type': '2',
                    'task': 'ISO-Anesthetic/Conscious',
                    'target_labels': [['iso_conscious_female'],
                                      ['iso_anesthesia_female']]
                },
                {
                    'classification_type': '2',
                    'task': 'Ketamine-Anesthetic/Conscious',
                    'target_labels': [['ketamine_conscious_female'],
                                      ['ketamine_anesthesia_female']]
                },
                {
                    'classification_type': '2',
                    'task': 'N2O-Anesthetic/Conscious',
                    'target_labels': [['N2O_conscious_female'],
                                      ['N2O_anesthesia_female']]
                },
                {
                    'classification_type': '2',
                    'task': 'Propofol-Anesthetic/Conscious',
                    'target_labels': [['propofol_conscious_female'],
                                      ['propofol_anesthesia_female']]
                },
                {
                    'classification_type': '2',
                    'task': 'ALL-Anesthetic/Conscious',
                    'target_labels': [['dex_conscious_female', 'iso_conscious_female', 'ketamine_conscious_female', 'N2O_conscious_female', 'propofol_conscious_female'],
                                      ['dex_anesthesia_female', 'iso_anesthesia_female', 'ketamine_anesthesia_female', 'N2O_anesthesia_female', 'propofol_anesthesia_female']]
                },
            ]
        },
        {
            ...
            'tasks': [
                {
                    'classification_type': '2',
                    'task': 'Dex-Anesthetic/Conscious',
                    'target_labels': [['dex_conscious_male'],
                                      ['dex_anesthesia_male']]
                },
                {
                    'classification_type': '2',
                    'task': 'ISO-Anesthetic/Conscious',
                    'target_labels': [['iso_conscious_male'],
                                      ['iso_anesthesia_male']]
                },
                {
                    'classification_type': '2',
                    'task': 'Ketamine-Anesthetic/Conscious',
                    'target_labels': [['ketamine_conscious_male'],
                                      ['ketamine_anesthesia_male']]
                },
                {
                    'classification_type': '2',
                    'task': 'N2O-Anesthetic/Conscious',
                    'target_labels': [['N2O_conscious_male'],
                                      ['N2O_anesthesia_male']]
                },
                {
                    'classification_type': '2',
                    'task': 'Propofol-Anesthetic/Conscious',
                    'target_labels': [['propofol_conscious_male'],
                                      ['propofol_anesthesia_male']]
                },
                {
                    'classification_type': '2',
                    'task': 'ALL-Anesthetic/Conscious',
                    'target_labels': [['dex_conscious_male', 'iso_conscious_male', 'ketamine_conscious_male',
                                       'N2O_conscious_male', 'propofol_conscious_male'],
                                      ['dex_anesthesia_male', 'iso_anesthesia_male', 'ketamine_anesthesia_male',
        ...
        },
        {
            ...
            'tasks': [
                ...
                },
                {
                    'classification_type': '2',
                    'task': 'ISO-Anesthetic/Conscious',
                    'target_labels': [['iso_conscious_female', 'iso_conscious_male'],
                                      ['iso_anesthesia_female', 'iso_anesthesia_male']]
                },
                {
                    'classification_type': '2',
                    'task': 'Ketamine-Anesthetic/Conscious',
                    'target_labels': [['ketamine_conscious_female', 'ketamine_conscious_male'],
                                      ['ketamine_anesthesia_female', 'ketamine_anesthesia_male']]
                },
                {
                    'classification_type': '2',
                    'task': 'N2O-Anesthetic/Conscious',
                    'target_labels': [['N2O_conscious_female', 'N2O_conscious_male'],
                                      ['N2O_anesthesia_female', 'N2O_anesthesia_male']]
                },
                {
                    'classification_type': '2',
                    'task': 'Propofol-Anesthetic/Conscious',
                    'target_labels': [['propofol_conscious_female', 'propofol_conscious_male'],
                                      ['propofol_anesthesia_female', 'propofol_anesthesia_male']]
                },
                {
                    'classification_type': '2',
                    'task': 'ALL-Anesthetic/Conscious',
                    'target_labels': [['dex_conscious_female', 'iso_conscious_female', 'ketamine_conscious_female',
                                       'N2O_conscious_female', 'propofol_conscious_female',
                                       'dex_conscious_male', 'iso_conscious_male', 'ketamine_conscious_male',
                                       'N2O_conscious_male', 'propofol_conscious_male'],
                                      ['dex_anesthesia_female', 'iso_anesthesia_female', 'ketamine_anesthesia_female',
                                       'N2O_anesthesia_female', 'propofol_anesthesia_female',
                                       'dex_anesthesia_male', 'iso_anesthesia_male', 'ketamine_anesthesia_male',
                                       'N2O_anesthesia_male', 'propofol_anesthesia_male']]
                },
            ]

...
if __name__ == '__main__':
    ...
    contribution_data_path = r"./results/receptor_contribution/group_imp.xlsx"
    save_name = f'./results/receptor_contribution_differences-top{topN}\high_specificity_receptors'
    os.makedirs(f'./results/receptor_contribution_differences-top{topN}', exist_ok=True)
    ...
    all_anesthetic_data = {
        'α2': filter_merge_and_remap_labels(blood_all_data, target_labels=[['dex_conscious_female', 'dex_conscious_male', 'dex_anesthesia_female', 'dex_anesthesia_male']])['matrix'],
        'GABA': filter_merge_and_remap_labels(blood_all_data, target_labels=[['iso_conscious_female', 'propofol_conscious_female', 'iso_conscious_male', 'propofol_conscious_male', 'iso_anesthesia_female', 'propofol_anesthesia_female', 'iso_anesthesia_male', 'propofol_anesthesia_male']])['matrix'],
        'NMDA': filter_merge_and_remap_labels(blood_all_data, target_labels=[['ketamine_conscious_female', 'N2O_conscious_female', 'ketamine_conscious_male', 'N2O_conscious_male', 'ketamine_anesthesia_female', 'N2O_anesthesia_female', 'ketamine_anesthesia_male', 'N2O_anesthesia_male']])['matrix'],
    }
